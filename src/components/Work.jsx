  ...
  const projects = [
    {
      ...
      description: 'Complete visual system for a luxury hospitality group.',
      tags: ['Branding', 'Identity', 'Systems'],
      image: w1,
    },
    {
      id: 2,
      title: 'Catalyst digital platform',
      description: 'Web experience redesign for a fintech startup scaling globally.',
      tags: ['Web design', 'Interface', 'Strategy'],
      image: w2,
    },
    {
      id: 3,
      title: 'Vesper campaign',
      description: 'Integrated campaign for a sustainable fashion collective.',
    ...
    <div ref={sectionRef} className="w-full h1 bg-black text-white py-24 px-6 sm:px-8 overflow-hidden" id='work-section'>
      <div className="max-w-7xl mx-auto">
              ...
              <div className="flex flex-col flex-grow">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.tags.map((tag, idx) => (
                    <span
                      key={idx}
                      className="project-tag text-xs font-semibold bg-gray-100 text-black px-3 py-1.5 rounded-full"
                    >
                      {tag}
                    </span>
                  ))}
        ...
        <div ref={linkRef} className="text-center pt-8 border-t border-gray-200">
          <a
            href="#"
            className="text-black font-semibold hover:text-purple-600 transition-colors duration-300 inline-flex items-center gap-2 text-lg"
          >
            All projects
